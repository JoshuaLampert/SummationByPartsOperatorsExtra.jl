...
function construct_function_space_operator(basis_functions, nodes,
    ...
    V = vandermonde_matrix(basis_functions_orthonormalized, nodes) * Diagonal(basis_function_weights)
    V_x = vandermonde_matrix(basis_functions_orthonormalized_derivatives, nodes) * Diagonal(basis_function_weights)
